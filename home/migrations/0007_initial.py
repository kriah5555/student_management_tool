    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[('MALE', 'MALE'), ('FEMALE', 'FEMALE'), ('GAY', 'GAY')], default='MALE', max_length=30)),
                ('branch', models.CharField(choices=[('MALE', 'MALE'), ('FEMALE', 'FEMALE'), ('GAY', 'GAY')], max_length=30)),
            ],
        ),
        migrations.CreateModel(
            name='Student',
