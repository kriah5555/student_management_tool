...
class UpdateStudent(UpdateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context["background"] = '/static/home/images/register.jpg'
        return context
...
class DeleteStudent(DeleteView):
    ...
    def get_context_data(self, **kwargs):
        context               = super().get_context_data(**kwargs)
        context["header"]     = 'Are u sure you want to delete!'
        ...
        if not Blockchain.is_chain_valid():
            ...
            for stu in students:
                if stu.student_usn in request.POST: 
                    ...
                    status = 0
                    pass
                # attendence = StudentAttendences.objects.create(branch = request.session['branch'], division = request.session['division'], sem = request.session['sem'], status = status, student_usn = stu.student_usn, subject = request.session['subject'])
